...
\begin{frame}{\sout{Magical beasts} Polar lows and where to find them}
...
\begin{itemize}
\item
Scarcely any research focused on the Svalbard as a trigger mechanism for polar lows
\item
Sea ice distribution is crucial in generation of the convergence zone, and organising it into a cyclonic system
\item
