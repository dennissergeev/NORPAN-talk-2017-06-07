...
\includegraphics[width=0.7\textwidth]{{figures/all_pl_tracks_ctrl_sic81n_nosva}.png}
\end{center}
\end{frame}
...
\includegraphics[width=0.7\textwidth]{{figures/all_pl_vort_ctrl_sic81n_nosva}.png}
\end{center}
\end{frame}
